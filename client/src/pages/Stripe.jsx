    ...
    <div className="bg-[#F9FBFC]">
      ...
      <div className="w-full bg-white shadow-md py-20 px-6 md:px-20 flex flex-col">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className=" bg-white shadow-md rounded-sm">
              <div className="flex items-center justify-between py-[8px] px-4 border-b border-gray-200">
               <select name="" id="" className="w-full outline-none text-[#1A1F36]">
                <option value="nigeria" defaultChecked>Nigeria</option>
                <option value="america" defaultChecked>America</option>
                <option value="india" defaultChecked>India</option>
                <option value="korea" defaultChecked>Korea</option>
                <option value="mecca" defaultChecked>Mecca</option>
               </select>
              </div>
          ...
          {/* pay button */}
            <button onClick={() => navigate("/thankyou")} className="flex cursor-pointer items-center font-500 text-[18px] text-white/40 justify-center h-[42px] bg-[#3C4257] rounded-[4px]">
